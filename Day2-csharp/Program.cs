			...
			while (true)
			{
				...
				switch (command)
				{
					case 1:
						...
						//originalCode.ToList().CopyTo(programCode);
						currentIndex += 4;
						break;
					case 2:
						...
						break;
					case 99:
						Console.WriteLine(programCode.Aggregate("", (s, i) => s + i + ", "));
						return;
				}
			}
